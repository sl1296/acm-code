    ...
    while(1){
        ...
        for(int i=0;i<ve.size();i++){
            if(strcmp(ss,ve[i].name)==0 || strcmp(ss,ve[i].sid)==0){
                printf("%d %s %d %s %d %d %d %d %d %.2f\n",ve[i].rrank,ve[i].sid,ve[i].cid,ve[i].name,ve[i].score[0],ve[i].score[1],ve[i].score[2],ve[i].score[3],ve[i].tot,ve[i].avg);
            }
        }
    }
}
void Showstat(){
    ...
    printf("Chinese\nAverage Score: %.2f\nNumber of passed students: %d\nNumber of failed students: %d\n\n",total[0]/(double)(pass[0]+fail[0]),pass[0],fail[0]);
    printf("Mathematics\nAverage Score: %.2f\nNumber of passed students: %d\nNumber of failed students: %d\n\n",total[1]/(double)(pass[1]+fail[1]),pass[1],fail[1]);
    printf("English\nAverage Score: %.2f\nNumber of passed students: %d\nNumber of failed students: %d\n\n",total[2]/(double)(pass[2]+fail[2]),pass[2],fail[2]);
    printf("Programming\nAverage Score: %.2f\nNumber of passed students: %d\nNumber of failed students: %d\n\n",total[3]/(double)(pass[3]+fail[3]),pass[3],fail[3]);
