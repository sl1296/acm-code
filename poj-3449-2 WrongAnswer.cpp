        ...
        while(1){
         ...
         //   printf("in=%s\n",in);
            if(in[0]=='s'){
                ...
                as[cnt].x.push_back(Point(min(a,c),min(b,d)));
                as[cnt].x.push_back(Point(min(a,c),max(b,d)));
                as[cnt].x.push_back(Point(max(a,c),max(b,d)));
                as[cnt].x.push_back(Point(max(a,c),min(b,d)));
            }else if(in[0]=='r'){
                double a,b,c,d,e,f;
                scanf(" (%lf,%lf) (%lf,%lf) (%lf,%lf)",&a,&b,&c,&d,&e,&f);
                as[cnt].x.push_back(Point(min(a,e),min(b,f)));
                as[cnt].x.push_back(Point(min(a,e),max(b,f)));
                as[cnt].x.push_back(Point(max(a,e),max(b,f)));
                as[cnt].x.push_back(Point(max(a,e),min(b,f)));
            }else if(in[0]=='l'){
                double a,b,c,d;
                scanf(" (%lf,%lf) (%lf,%lf)",&a,&b,&c,&d);
