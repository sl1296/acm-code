...
code.cpp:30:22: warning: 'char* gets(char*)' is deprecated [-Wdeprecated-declarations]
         gets(ar[0][0]);
                      ^
...
/usr/include/stdio.h:641:14: note: declared here
 extern char *gets (char *__s) __wur __attribute_deprecated__;
              ^~~~
code.cpp:34:36: warning: 'char* gets(char*)' is deprecated [-Wdeprecated-declarations]
                 gets(ar[i][line[i]]);
                                    ^
In file included from /usr/include/c++/7.1.1/cstdio:42:0,
                 from code.cpp:1:
/usr/include/stdio.h:641:14: note: declared here
 extern char *gets (char *__s) __wur __attribute_deprecated__;
              ^~~~
code.cpp:41:16: warning: 'char* gets(char*)' is deprecated [-Wdeprecated-declarations]
         gets(in);
                ^
In file included from /usr/include/c++/7.1.1/cstdio:42:0,
                 from code.cpp:1:
/usr/include/stdio.h:641:14: note: declared here
 extern char *gets (char *__s) __wur __attribute_deprecated__;
              ^~~~
code.cpp:43:16: error: 'i' was not declared in this scope
             if(i)printf("==========\n");
                ^
code.cpp:43:16: note: suggested alternative: 'ii'
             if(i)printf("==========\n");
                ^
                ii
code.cpp:44:20: warning: 'char* gets(char*)' is deprecated [-Wdeprecated-declarations]
             gets(in);
                    ^
In file included from /usr/include/c++/7.1.1/cstdio:42:0,
                 from code.cpp:1:
